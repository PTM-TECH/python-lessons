...
weekend = input("Does the rental period include a weekend day (yes/no): ").lower()
...
if weekend == "yes":
	...
	print(f"The total cost of the car rental for {days} days at ${cost} per day and with a 10% weekend discount comes to: ${total_cost:.2f}")
else:
	print(f"The total cost of the car rental for {days} days at ${cost} per day comes out to: ${base_cost:.2f}")